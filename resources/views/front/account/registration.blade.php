        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                fields.forEach(field => {
                    ...
                    const feedbackField = errorField.siblings('p');

                    if (response.status === false && response.errors[field]) {
                        errorField.addClass('is-invalid');
                        feedbackField.addClass('invalid-feedback').html(response.errors[field]);
                    } else {
                        errorField.removeClass('is-invalid');
                        feedbackField.removeClass('invalid-feedback').html('');
